...
def listar(request):
	result1 = Pessoa.objects.raw('SELECT * FROM people_pessoa')
	result2 = Pessoa.objects.raw('SELECT * FROM people_pessoa where idade > 19')
	result3 = Pessoa.objects.raw('SELECT id,nome FROM people_pessoa UNION SELECT id,nome FROM people_animalestimacao')
	result4 = Pessoa.objects.raw('SELECT id,COUNT(*) AS total FROM people_pessoa')
